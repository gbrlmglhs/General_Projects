		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#brasileiraogbrl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brasileiraogbrl-display": {
								"semanticObject": "brasileiraogbrl",
								"action": "display",
								"description": "Campeonato Brasileiro de futebol 2023 - FioriNET",
								"title": "Campeonato Brasileiro de futebol 2023",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=brasileiraogbrl",
									"url": sap.ui.require.toUrl("brasileiraogbrl")
								}
							}
						}
					}
